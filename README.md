...
* You must have at least `Node 14.16` installed on your system.
* To build the app you must use the target platform you’re building for. If you’re building for macOS, use a Mac. If you’re building for Windows, use a PC.
