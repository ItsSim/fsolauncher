...
class Modal {
    ...
    static showRequirementsNotMet(Missing) {
        Modal.View.sendModal(
            ...
            global.locale.MODAL_NOT_AVAILABLE_DESCR_1 + " <strong>" +
            Missing.join(', ') +
            "</strong> " + global.locale.MODAL_NOT_AVAILABLE_DESCR_2,
    ...
    static showFirstInstall(ComponentName, ComponentID) {
        Modal.View.sendModal(
            ...
            global.locale.MODAL_INSTALL_DESCR_1 + " <strong>" + ComponentName + "</strong> " + global.locale.MODAL_INSTALL_DESCR_2,
    ...
    static showReInstall(ComponentName, ComponentID) {
        Modal.View.sendModal(
            ...
            global.locale.MODAL_REINSTALL_DESCR_X + " <strong>" + ComponentName + "</strong>?",
    ...
    static showFailedInstall(ComponentName, ErrorMessage) {
        Modal.View.sendModal(
            ...
            ComponentName + " " + global.locale.MODAL_INS_FAILED_DESCR_1 + " " + ErrorMessage,
            global.locale.MODAL_OK2
        )
    }
    /**
    ...
    static showAlreadyInstalled(ComponentName, ComponentID, path) {
        ...
        Modal.View.sendModal(
            global.locale.MODAL_NOT_AVAILABLE2,
            global.locale.MODAL_DETECTED_THAT_1 + " <strong>" + ComponentName + "</strong> " + global.locale.MODAL_DETECTED_THAT_2,
    ...
    static showCHTTSComplete(value) {
        Modal.View.sendModal(
            value === '1' ? global.locale.MODAL_SUCCESS : global.locale.MODAL_TTS_DISABLED,
            value === '1' ?
    ...
    static showInstallUpdate(v) {
        Modal.View.sendModal(
            ...
            global.locale.MODAL_INSTALL_UPDATE_DESCR_1 + v + global.locale.MODAL_INSTALL_UPDATE_DESCR_2,
